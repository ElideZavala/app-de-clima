     ...
     async ciudad( lugar = '' ) {
          ...
          try {
               ...
               const intance = axios.create({
                    baseURL: `https://api.mapbox.com/geocoding/v5/mapbox.places/${lugar}.json ?access_token=pk eyJ1IjoiZWxkZXphdmFsYSIsImEiOiJja25jYm4zeWoxcXZoMnZvem1uMnVnZ284In0.V5Ei9_6BtZQY0-V4H99vvQ&limit=5&language=es`
               })
